...
const Modules: React.FC<ModulesProps> = ({ onSelectModule, user, serviceId }) => {
        ...
        {isLoading ? (<div>Loading modules...</div>) : error ? (<div className="text-red-500">{error}</div>) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div key={module.id} 
                    ...
                    <div onClick={() => onSelectModule(module.name)} className="flex items-center cursor-pointer flex-grow">
